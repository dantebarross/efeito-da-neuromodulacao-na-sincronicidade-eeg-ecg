...
\end{itemize}
A comparação entre as análises com e sem remoção de \texit{outliers} demonstrou que os padrões gerais se mantêm, confirmando a robustez dos achados.
...
\begin{itemize}
    ...
    \item As bandas \emph{delta} e \emph{gamma} evidenciaram maior sensibilidade à remoção de \texit{outliers}, embora a análise tenha apontado a relevância de regiões parietais e frontais, respectivamente.
\end{itemize}
