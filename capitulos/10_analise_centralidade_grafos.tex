...
\begin{figure}[H]
    ...
    \caption{\small \textbf{\textit{Degree Centrality} - Banda Beta (13-30 Hz):} A hierarquia na rede beta destaca consistentemente \textbf{TPP7h} como o \textit{hub} principal, com pequenas variações na ordem dos outros canais entre os cenários.}
